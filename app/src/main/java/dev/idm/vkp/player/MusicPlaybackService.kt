...
import dev.idm.vkp.media.exo.ExoUtil
...
import dev.idm.vkp.util.DownloadWorkUtils.GetLocalTrackLink
import dev.idm.vkp.util.DownloadWorkUtils.TrackIsDownloaded
import dev.idm.vkp.util.Logger
import dev.idm.vkp.util.RxUtils
import dev.idm.vkp.util.Utils
import dev.idm.vkp.util.Utils.makeMediaItem
...
class MusicPlaybackService : Service() {
    private val SHUTDOWN = "dev.idm.vkp.player.shutdown"
    ...
    companion object {
        ...
        const val PLAYSTATE_CHANGED = "dev.idm.vkp.player.playstatechanged"
        const val POSITION_CHANGED = "dev.idm.vkp.player.positionchanged"
        const val META_CHANGED = "dev.idm.vkp.player.metachanged"
        const val PREPARED = "dev.idm.vkp.player.prepared"
        const val REPEATMODE_CHANGED = "dev.idm.vkp.player.repeatmodechanged"
        const val SHUFFLEMODE_CHANGED = "dev.idm.vkp.player.shufflemodechanged"
        const val QUEUE_CHANGED = "dev.idm.vkp.player.queuechanged"
        const val SERVICECMD = "dev.idm.vkp.player.musicservicecommand"
        const val TOGGLEPAUSE_ACTION = "dev.idm.vkp.player.togglepause"
        const val PAUSE_ACTION = "dev.idm.vkp.player.pause"
        const val STOP_ACTION = "dev.idm.vkp.player.stop"
        const val SWIPE_DISMISS_ACTION = "dev.idm.vkp.player.swipe_dismiss"
        const val PREVIOUS_ACTION = "dev.idm.vkp.player.previous"
        const val NEXT_ACTION = "dev.idm.vkp.player.next"
        const val REPEAT_ACTION = "dev.idm.vkp.player.repeat"
        const val SHUFFLE_ACTION = "dev.idm.vkp.player.shuffle"

        /**
         * Called to update the service about the foreground state of Apollo's activities
         */
        const val FOREGROUND_STATE_CHANGED = "dev.idm.vkp.player.fgstatechanged"
        const val NOW_IN_FOREGROUND = "nowinforeground"
        const val FROM_MEDIA_BUTTON = "frommediabutton"
        const val REFRESH = "dev.idm.vkp.player.refresh"
