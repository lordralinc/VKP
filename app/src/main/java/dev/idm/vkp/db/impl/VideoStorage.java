...
import dev.idm.vkp.db.MessengerContentProvider;
import dev.idm.vkp.db.column.VideoColumns;
import dev.idm.vkp.db.interfaces.IVideoStorage;
import dev.idm.vkp.db.model.entity.PrivacyEntity;
...
import static dev.idm.vkp.db.column.VideoColumns.ACCESS_KEY;
import static dev.idm.vkp.db.column.VideoColumns.ADDING_DATE;
import static dev.idm.vkp.db.column.VideoColumns.ALBUM_ID;
import static dev.idm.vkp.db.column.VideoColumns.CAN_COMENT;
import static dev.idm.vkp.db.column.VideoColumns.CAN_REPOST;
import static dev.idm.vkp.db.column.VideoColumns.COMMENTS;
import static dev.idm.vkp.db.column.VideoColumns.DATE;
import static dev.idm.vkp.db.column.VideoColumns.DESCRIPTION;
import static dev.idm.vkp.db.column.VideoColumns.DURATION;
import static dev.idm.vkp.db.column.VideoColumns.EXTERNAL;
import static dev.idm.vkp.db.column.VideoColumns.HLS;
import static dev.idm.vkp.db.column.VideoColumns.IMAGE;
import static dev.idm.vkp.db.column.VideoColumns.LIKES;
import static dev.idm.vkp.db.column.VideoColumns.LINK;
import static dev.idm.vkp.db.column.VideoColumns.LIVE;
import static dev.idm.vkp.db.column.VideoColumns.MP4_1080;
import static dev.idm.vkp.db.column.VideoColumns.MP4_240;
import static dev.idm.vkp.db.column.VideoColumns.MP4_360;
import static dev.idm.vkp.db.column.VideoColumns.MP4_480;
import static dev.idm.vkp.db.column.VideoColumns.MP4_720;
import static dev.idm.vkp.db.column.VideoColumns.ORIGINAL_OWNER_ID;
import static dev.idm.vkp.db.column.VideoColumns.OWNER_ID;
import static dev.idm.vkp.db.column.VideoColumns.PLAYER;
import static dev.idm.vkp.db.column.VideoColumns.PRIVACY_COMMENT;
import static dev.idm.vkp.db.column.VideoColumns.PRIVACY_VIEW;
import static dev.idm.vkp.db.column.VideoColumns.REPEAT;
import static dev.idm.vkp.db.column.VideoColumns.TITLE;
import static dev.idm.vkp.db.column.VideoColumns.USER_LIKES;
import static dev.idm.vkp.db.column.VideoColumns.VIDEO_ID;
import static dev.idm.vkp.db.column.VideoColumns.VIEWS;
