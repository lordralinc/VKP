...
import static dev.idm.vkp.db.MessengerContentProvider.getPostsContentUriFor;
import static dev.idm.vkp.db.impl.AttachmentsStorage.appendAttachOperationWithBackReference;
