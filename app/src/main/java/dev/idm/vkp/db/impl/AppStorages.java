...
import dev.idm.vkp.db.interfaces.IAttachmentsStorage;
import dev.idm.vkp.db.interfaces.ICommentsStorage;
...
import dev.idm.vkp.db.interfaces.IFaveStorage;
import dev.idm.vkp.db.interfaces.IFeedStorage;
import dev.idm.vkp.db.interfaces.IFeedbackStorage;
import dev.idm.vkp.db.interfaces.IKeysStorage;
import dev.idm.vkp.db.interfaces.ILocalMediaStorage;
import dev.idm.vkp.db.interfaces.IMessagesStorage;
import dev.idm.vkp.db.interfaces.IOwnersStorage;
import dev.idm.vkp.db.interfaces.IPhotoAlbumsStorage;
import dev.idm.vkp.db.interfaces.IPhotosStorage;
import dev.idm.vkp.db.interfaces.IRelativeshipStorage;
import dev.idm.vkp.db.interfaces.IStickersStorage;
import dev.idm.vkp.db.interfaces.IStorages;
import dev.idm.vkp.db.interfaces.ITempDataStorage;
import dev.idm.vkp.db.interfaces.ITopicsStore;
import dev.idm.vkp.db.interfaces.IVideoAlbumsStorage;
import dev.idm.vkp.db.interfaces.IVideoStorage;
import dev.idm.vkp.db.interfaces.IWallStorage;
