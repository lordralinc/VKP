...
import static dev.idm.vkp.util.Utils.joinNonEmptyStrings;
...
public class UserDetailsPresenter extends AccountDependencyPresenter<IUserDetailsView> {
    ...
    public List<AdvancedItem> createData() {
        ...
        items.add(new AdvancedItem(1, AdvancedItem.TYPE_COPY_DETAILS_ONLY, new Text(R.string.domain))
        ...
        items.add(new AdvancedItem(1, AdvancedItem.TYPE_COPY_DETAILS_ONLY, new Text(R.string.id))
                .setSubtitle(new Text(String.valueOf(user.getId())))
                .setIcon(Icon.fromResources(R.drawable.ic_cookies_white))
                .setSection(mainSection));
