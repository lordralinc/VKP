...
import dev.idm.vkp.db.model.PostPatch;
...
public class WallsRepository implements IWallsRepository {
    ...
    private final PublishSubject<dev.idm.vkp.model.IdPair> postInvalidatePublisher = PublishSubject.create();
    ...
    private Completable invalidatePost(int accountId, int postId, int ownerId) {
        dev.idm.vkp.model.IdPair pair = new dev.idm.vkp.model.IdPair(postId, ownerId);
    ...
    @Override
    public Observable<dev.idm.vkp.model.IdPair> observePostInvalidation() {
