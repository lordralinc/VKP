...
import dev.idm.vkp.domain.impl.CountersInteractor;
import dev.idm.vkp.fragment.AbsWallFragment;
import dev.idm.vkp.fragment.AdditionalNavigationFragment;
import dev.idm.vkp.fragment.AnswerVKOfficialFragment;
import dev.idm.vkp.fragment.AudioCatalogFragment;
import dev.idm.vkp.fragment.AudioPlayerFragment;
import dev.idm.vkp.fragment.AudiosByArtistFragment;
import dev.idm.vkp.fragment.AudiosFragment;
import dev.idm.vkp.fragment.AudiosInCatalogFragment;
import dev.idm.vkp.fragment.AudiosTabsFragment;
import dev.idm.vkp.fragment.BrowserFragment;
import dev.idm.vkp.fragment.ChatFragment;
import dev.idm.vkp.fragment.ChatUsersFragment;
import dev.idm.vkp.fragment.CommentsFragment;
import dev.idm.vkp.fragment.CommunitiesFragment;
import dev.idm.vkp.fragment.CommunityBanEditFragment;
import dev.idm.vkp.fragment.CommunityControlFragment;
import dev.idm.vkp.fragment.CommunityInfoContactsFragment;
import dev.idm.vkp.fragment.CommunityInfoLinksFragment;
import dev.idm.vkp.fragment.CommunityManagerEditFragment;
import dev.idm.vkp.fragment.CreatePhotoAlbumFragment;
import dev.idm.vkp.fragment.CreatePollFragment;
import dev.idm.vkp.fragment.DialogsFragment;
import dev.idm.vkp.fragment.DocPreviewFragment;
import dev.idm.vkp.fragment.DocsFragment;
import dev.idm.vkp.fragment.DrawerEditFragment;
...
import dev.idm.vkp.fragment.GiftsFragment;
import dev.idm.vkp.fragment.ImportantMessagesFragment;
import dev.idm.vkp.fragment.LikesFragment;
import dev.idm.vkp.fragment.LinksInCatalogFragment;
import dev.idm.vkp.fragment.LogsFragement;
import dev.idm.vkp.fragment.MarketViewFragment;
import dev.idm.vkp.fragment.MessagesLookFragment;
import dev.idm.vkp.fragment.NewsfeedCommentsFragment;
import dev.idm.vkp.fragment.NewsfeedMentionsFragment;
import dev.idm.vkp.fragment.NotReadMessagesFragment;
import dev.idm.vkp.fragment.NotificationPreferencesFragment;
import dev.idm.vkp.fragment.OwnerArticlesFragment;
import dev.idm.vkp.fragment.PhotoAllCommentFragment;
import dev.idm.vkp.fragment.PhotoPagerFragment;
import dev.idm.vkp.fragment.PlaylistsInCatalogFragment;
import dev.idm.vkp.fragment.PollFragment;
import dev.idm.vkp.fragment.PreferencesFragment;
import dev.idm.vkp.fragment.ProductAlbumsFragment;
import dev.idm.vkp.fragment.ProductsFragment;
import dev.idm.vkp.fragment.RequestExecuteFragment;
import dev.idm.vkp.fragment.SecurityPreferencesFragment;
import dev.idm.vkp.fragment.ShortedLinksFragment;
import dev.idm.vkp.fragment.SinglePhotoFragment;
import dev.idm.vkp.fragment.StoryPagerFragment;
import dev.idm.vkp.fragment.ThemeFragment;
import dev.idm.vkp.fragment.TopicsFragment;
import dev.idm.vkp.fragment.UserBannedFragment;
import dev.idm.vkp.fragment.UserDetailsFragment;
...
import dev.idm.vkp.fragment.VideosInCatalogFragment;
import dev.idm.vkp.fragment.VideosTabsFragment;
import dev.idm.vkp.fragment.WallPostFragment;
import dev.idm.vkp.fragment.attachments.CommentCreateFragment;
import dev.idm.vkp.fragment.attachments.CommentEditFragment;
import dev.idm.vkp.fragment.attachments.PostCreateFragment;
import dev.idm.vkp.fragment.attachments.PostEditFragment;
...
import dev.idm.vkp.fragment.wallattachments.WallAttachmentsFragmentFactory;
import dev.idm.vkp.link.LinkHelper;
import dev.idm.vkp.listener.AppStyleable;
...
import dev.idm.vkp.settings.SwipesChatMode;
import dev.idm.vkp.upload.impl.AudioUploadable;
import dev.idm.vkp.util.Accounts;
import dev.idm.vkp.util.Action;
...
public class MainActivity extends AppCompatActivity implements AdditionalNavigationFragment.NavigationDrawerCallbacks,
    ...
    public static final String ACTION_CHAT_FROM_SHORTCUT = "dev.idm.vkp.ACTION_CHAT_FROM_SHORTCUT";
    public static final String ACTION_OPEN_PLACE = "dev.idm.vkp.activity.MainActivity.openPlace";
    public static final String ACTION_OPEN_AUDIO_PLAYER = "dev.idm.vkp.activity.MainActivity.openAudioPlayer";
    public static final String ACTION_SEND_ATTACHMENTS = "dev.idm.vkp.ACTION_SEND_ATTACHMENTS";
    public static final String ACTION_SWITH_ACCOUNT = "dev.idm.vkp.ACTION_SWITH_ACCOUNT";
    public static final String ACTION_OPEN_WALL = "dev.idm.vkp.ACTION_OPEN_WALL";

    public static final String EXTRA_NO_REQUIRE_PIN = "no_require_pin";

    /**
     * Extra with type {@link dev.idm.vkp.model.ModelsBundle} only
     */
