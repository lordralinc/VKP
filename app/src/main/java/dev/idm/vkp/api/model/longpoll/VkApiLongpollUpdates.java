package dev.idm.vkp.api.model.longpoll;

import java.util.ArrayList;
import java.util.List;

import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_COUNTER_UNREAD_WAS_CHANGED;
import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_MESSAGES_FLAGS_RESET;
import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_MESSAGES_FLAGS_SET;
import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_MESSAGE_ADDED;
import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_MESSAGE_CHANGED;
import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_MESSAGE_EDITED;
import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_SET_INPUT_MESSAGES_AS_READ;
import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_SET_OUTPUT_MESSAGES_AS_READ;
import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_USER_IS_OFFLINE;
import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_USER_IS_ONLINE;
import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_USER_WRITE_TEXT_IN_DIALOG;
import static dev.idm.vkp.api.model.longpoll.AbsLongpollEvent.ACTION_USER_WRITE_VOICE_IN_DIALOG;
import static dev.idm.vkp.util.Utils.safeCountOfMultiple;
