...
import dev.idm.vkp.api.model.VKApiPhotoTags;
import dev.idm.vkp.api.model.VkApiPrivacy;
import dev.idm.vkp.api.model.response.DefaultCommentsResponse;
import dev.idm.vkp.api.model.response.UploadChatPhotoResponse;
import dev.idm.vkp.api.model.response.UploadOwnerPhotoResponse;
import dev.idm.vkp.api.model.server.VkApiChatPhotoUploadServer;
import dev.idm.vkp.api.model.server.VkApiOwnerPhotoUploadServer;
import dev.idm.vkp.api.model.server.VkApiPhotoMessageServer;
import dev.idm.vkp.api.model.server.VkApiUploadServer;
import dev.idm.vkp.api.model.server.VkApiWallUploadServer;
import dev.idm.vkp.api.services.IPhotosService;
