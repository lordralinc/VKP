...
import dev.idm.vkp.api.model.VKApiCareer;
import dev.idm.vkp.api.model.VKApiCity;
import dev.idm.vkp.api.model.VKApiCountry;
import dev.idm.vkp.api.model.VKApiMilitary;
import dev.idm.vkp.api.model.VKApiSchool;
import dev.idm.vkp.api.model.VKApiUniversity;
import dev.idm.vkp.api.model.VKApiUser;
import dev.idm.vkp.api.util.VKStringUtils;

import static dev.idm.vkp.api.model.VKApiUser.CAMERA_50;
import static dev.idm.vkp.api.model.VKApiUser.Field.ABOUT;
import static dev.idm.vkp.api.model.VKApiUser.Field.ACTIVITIES;
import static dev.idm.vkp.api.model.VKApiUser.Field.ACTIVITY;
import static dev.idm.vkp.api.model.VKApiUser.Field.BDATE;
import static dev.idm.vkp.api.model.VKApiUser.Field.BLACKLISTED_BY_ME;
import static dev.idm.vkp.api.model.VKApiUser.Field.BOOKS;
import static dev.idm.vkp.api.model.VKApiUser.Field.CAN_POST;
import static dev.idm.vkp.api.model.VKApiUser.Field.CAN_SEE_ALL_POSTS;
import static dev.idm.vkp.api.model.VKApiUser.Field.CAN_WRITE_PRIVATE_MESSAGE;
import static dev.idm.vkp.api.model.VKApiUser.Field.CAREER;
import static dev.idm.vkp.api.model.VKApiUser.Field.CITY;
import static dev.idm.vkp.api.model.VKApiUser.Field.COUNTERS;
import static dev.idm.vkp.api.model.VKApiUser.Field.COUNTRY;
import static dev.idm.vkp.api.model.VKApiUser.Field.GAMES;
import static dev.idm.vkp.api.model.VKApiUser.Field.HOME_TOWN;
import static dev.idm.vkp.api.model.VKApiUser.Field.INTERESTS;
import static dev.idm.vkp.api.model.VKApiUser.Field.LAST_SEEN;
import static dev.idm.vkp.api.model.VKApiUser.Field.MILITARY;
import static dev.idm.vkp.api.model.VKApiUser.Field.MOVIES;
import static dev.idm.vkp.api.model.VKApiUser.Field.ONLINE;
import static dev.idm.vkp.api.model.VKApiUser.Field.ONLINE_MOBILE;
import static dev.idm.vkp.api.model.VKApiUser.Field.PERSONAL;
import static dev.idm.vkp.api.model.VKApiUser.Field.PHOTO_100;
import static dev.idm.vkp.api.model.VKApiUser.Field.PHOTO_200;
import static dev.idm.vkp.api.model.VKApiUser.Field.PHOTO_50;
import static dev.idm.vkp.api.model.VKApiUser.Field.PHOTO_MAX_ORIG;
import static dev.idm.vkp.api.model.VKApiUser.Field.QUOTES;
import static dev.idm.vkp.api.model.VKApiUser.Field.RELATION;
import static dev.idm.vkp.api.model.VKApiUser.Field.RELATIVES;
import static dev.idm.vkp.api.model.VKApiUser.Field.SCHOOLS;
import static dev.idm.vkp.api.model.VKApiUser.Field.SEX;
import static dev.idm.vkp.api.model.VKApiUser.Field.SITE;
import static dev.idm.vkp.api.model.VKApiUser.Field.STATUS;
import static dev.idm.vkp.api.model.VKApiUser.Field.TV;
import static dev.idm.vkp.api.model.VKApiUser.Field.UNIVERSITIES;
import static dev.idm.vkp.api.model.VKApiUser.Field.VERIFIED;
import static dev.idm.vkp.api.model.VKApiUser.Field.WALL_DEFAULT;
