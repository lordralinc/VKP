...
import dev.idm.vkp.api.model.VkApiLongpollServer;
import dev.idm.vkp.api.model.response.AttachmentsHistoryResponse;
import dev.idm.vkp.api.model.response.ConversationDeleteResult;
import dev.idm.vkp.api.model.response.ConversationsResponse;
import dev.idm.vkp.api.model.response.DialogsResponse;
import dev.idm.vkp.api.model.response.ItemsProfilesGroupsResponse;
import dev.idm.vkp.api.model.response.LongpollHistoryResponse;
import dev.idm.vkp.api.model.response.MessageHistoryResponse;
import dev.idm.vkp.api.model.response.MessageImportantResponse;
import dev.idm.vkp.api.services.IMessageService;
