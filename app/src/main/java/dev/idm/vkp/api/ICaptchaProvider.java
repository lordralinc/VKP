...
import dev.idm.vkp.api.model.Captcha;
...
public interface ICaptchaProvider {
     ...
     * После выполнения этого метода следует периодически проверять {@link dev.idm.vkp.api.ICaptchaProvider#lookupCode}
     *
     * @param sid     код капчи
     * @param captcha капча
     */
     ...
     * с помощью метода {@link dev.idm.vkp.api.ICaptchaProvider#notifyThatCaptchaEntryActive}
