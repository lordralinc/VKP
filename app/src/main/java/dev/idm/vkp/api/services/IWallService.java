...
import dev.idm.vkp.api.model.response.CommentCreateResponse;
import dev.idm.vkp.api.model.response.DefaultCommentsResponse;
import dev.idm.vkp.api.model.response.PostCreateResponse;
import dev.idm.vkp.api.model.response.PostsResponse;
import dev.idm.vkp.api.model.response.RepostReponse;
import dev.idm.vkp.api.model.response.WallEditReponce;
import dev.idm.vkp.api.model.response.WallResponse;
import dev.idm.vkp.api.model.response.WallSearchResponse;
