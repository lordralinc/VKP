...
import dev.idm.vkp.api.RetrofitWrapper;
...
import dev.idm.vkp.api.interfaces.IAudioApi;
import dev.idm.vkp.api.interfaces.IBoardApi;
import dev.idm.vkp.api.interfaces.ICommentsApi;
import dev.idm.vkp.api.interfaces.IDatabaseApi;
import dev.idm.vkp.api.interfaces.IDocsApi;
import dev.idm.vkp.api.interfaces.IFaveApi;
import dev.idm.vkp.api.interfaces.IFriendsApi;
import dev.idm.vkp.api.interfaces.IGroupsApi;
import dev.idm.vkp.api.interfaces.ILikesApi;
import dev.idm.vkp.api.interfaces.IMessagesApi;
import dev.idm.vkp.api.interfaces.INewsfeedApi;
import dev.idm.vkp.api.interfaces.INotificationsApi;
import dev.idm.vkp.api.interfaces.IOtherApi;
...
import dev.idm.vkp.api.interfaces.IUsersApi;
import dev.idm.vkp.api.interfaces.IUtilsApi;
import dev.idm.vkp.api.interfaces.IVideoApi;
import dev.idm.vkp.api.interfaces.IWallApi;
import io.reactivex.rxjava3.core.Single;

import static dev.idm.vkp.util.Utils.intValueIn;
