...
import dev.idm.vkp.upload.impl.ChatPhotoUploadable;
import dev.idm.vkp.upload.impl.DocumentUploadable;
import dev.idm.vkp.upload.impl.OwnerPhotoUploadable;
import dev.idm.vkp.upload.impl.Photo2AlbumUploadable;
import dev.idm.vkp.upload.impl.Photo2MessageUploadable;
import dev.idm.vkp.upload.impl.Photo2WallUploadable;
import dev.idm.vkp.upload.impl.StoryUploadable;
import dev.idm.vkp.upload.impl.Video2WallUploadable;
import dev.idm.vkp.upload.impl.VideoToMessageUploadable;
import dev.idm.vkp.upload.impl.VideoUploadable;
