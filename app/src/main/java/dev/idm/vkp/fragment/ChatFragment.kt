...
import dev.idm.vkp.*
import dev.idm.vkp.activity.*
import dev.idm.vkp.adapter.AttachmentsBottomSheetAdapter
...
import dev.idm.vkp.dialog.LandscapeExpandBottomSheetDialog
...
import dev.idm.vkp.fragment.sheet.MessageAttachmentsFragment
...
import dev.idm.vkp.modalbottomsheetdialogfragment.Option
import dev.idm.vkp.modalbottomsheetdialogfragment.OptionRequest
import dev.idm.vkp.model.*
import dev.idm.vkp.model.Types
import dev.idm.vkp.model.selection.*
import dev.idm.vkp.mvp.core.IPresenterFactory
import dev.idm.vkp.mvp.presenter.ChatPresenter
import dev.idm.vkp.mvp.view.IChatView
...
import dev.idm.vkp.util.Utils.nonEmpty
import dev.idm.vkp.view.InputViewController
...
import dev.idm.vkp.view.emoji.EmojiconsPopup
import dev.idm.vkp.view.emoji.StickersKeyWordsAdapter
...
//              bringChildToFront(v)
    ...
    private fun insertCommand(command: Command) {
        AppendMessageText(command.command);
    }
