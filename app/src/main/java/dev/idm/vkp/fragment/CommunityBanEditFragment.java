...
import dev.idm.vkp.mvp.presenter.CommunityBanEditPresenter;
import dev.idm.vkp.mvp.view.ICommunityBanEditView;
import dev.idm.vkp.picasso.transforms.RoundTransformation;
import dev.idm.vkp.place.PlaceFactory;
import dev.idm.vkp.util.FormatUtil;
import dev.idm.vkp.util.Objects;
import dev.idm.vkp.util.Utils;
import dev.idm.vkp.util.ViewUtils;
import dev.idm.vkp.view.MySpinnerView;
