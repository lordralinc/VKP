...
import dev.idm.vkp.mvp.presenter.EditPhotoAlbumPresenter;
import dev.idm.vkp.mvp.view.IEditPhotoAlbumView;
import dev.idm.vkp.util.AssertUtils;
import dev.idm.vkp.util.Objects;
import dev.idm.vkp.view.steppers.base.AbsStepHolder;
import dev.idm.vkp.view.steppers.base.AbsSteppersVerticalAdapter;
import dev.idm.vkp.view.steppers.impl.CreatePhotoAlbumStep1Holder;
import dev.idm.vkp.view.steppers.impl.CreatePhotoAlbumStep2Holder;
import dev.idm.vkp.view.steppers.impl.CreatePhotoAlbumStep3Holder;
import dev.idm.vkp.view.steppers.impl.CreatePhotoAlbumStep4Holder;
