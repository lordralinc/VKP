package dev.idm.vkp.fragment.sheet;
...
import dev.idm.vkp.activity.AttachmentsActivity;
import dev.idm.vkp.activity.AudioSelectActivity;
import dev.idm.vkp.activity.DualTabPhotoActivity;
import dev.idm.vkp.activity.VideoSelectActivity;
...
import dev.idm.vkp.model.selection.LocalGallerySelectableSource;
...
import dev.idm.vkp.model.selection.VkPhotosSelectableSource;
import dev.idm.vkp.mvp.core.IPresenterFactory;
import dev.idm.vkp.mvp.presenter.MessageAttachmentsPresenter;
import dev.idm.vkp.mvp.view.IMessageAttachmentsView;
