...
import dev.idm.vkp.push.PushType;
import dev.idm.vkp.push.message.BirthdayFCMMessage;
import dev.idm.vkp.push.message.CommentFCMMessage;
import dev.idm.vkp.push.message.FCMMessage;
import dev.idm.vkp.push.message.FriendAcceptedFCMMessage;
import dev.idm.vkp.push.message.FriendFCMMessage;
import dev.idm.vkp.push.message.GroupInviteFCMMessage;
import dev.idm.vkp.push.message.LikeFCMMessage;
import dev.idm.vkp.push.message.NewPostPushMessage;
import dev.idm.vkp.push.message.ReplyFCMMessage;
import dev.idm.vkp.push.message.WallPostFCMMessage;
import dev.idm.vkp.push.message.WallPublishFCMMessage;
...
public class FcmListenerService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage message) {
        ...
        if (isEmpty(pushType) || Settings.get().other().isSettingsNoPush()) {
            return;
        }
